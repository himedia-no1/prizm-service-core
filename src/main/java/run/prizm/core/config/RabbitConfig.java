...
public class RabbitConfig {
    ...
    // RabbitTemplate 등록
    // Spring Boot AutoConfiguration이 ConnectionFactory, RabbitTemplate, AmqpAdmin 등을 자동으로 구성해줌
    // RabbitTemplate을 customizing 할 때만 Bean을 직접 생성하면 됨
    @Bean
